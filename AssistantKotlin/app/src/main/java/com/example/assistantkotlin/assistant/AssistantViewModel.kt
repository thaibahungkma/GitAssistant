...
import com.example.assistantkotlin.data.Assistant
import com.example.assistantkotlin.data.AssistantDao
            ...
            application: Application): AndroidViewModel(application)
{
    ...
    private fun initializeCurrentMessage() {
        uiScope.launch { currentMessage.value=currentMessageFromDatabase() }
    }

    private suspend fun currentMessageFromDatabase(): Assistant? {
    ...
    fun sendMessageToDatabase(assistantMessage: String,humanMessage:String){
        uiScope.launch {
            ...
            insert(newAssistant)
            currentMessage.value=currentMessageFromDatabase()
        }
    }
